        ...
        switch (opcao) {
            ...
            case 1:
                ...
                if (encontrou) {
                    ...
                    printf("\nInserindo novo funcionario no sistema...\n");
            ...
            case 2:
                ...
                // 5. Tratamento dos resultados da pesquisa
                if (qtdEncontrados == 0) {
                ...
                if (qtdEncontrados == 1) {
                    ...
                    for (int i = 0; i < qtdEncontrados; i++) {
                        printf("[%d] %s - Data de Nascimento: %02d/%02d/%04d\n", 
                               i + 1, 
                               chavesEncontradas[i].nome, 
                               chavesEncontradas[i].dataNascimento.dia, 
                               chavesEncontradas[i].dataNascimento.mes, 
                               chavesEncontradas[i].dataNascimento.ano);
                    }
            ...
            case 3:
                ...
                int indice;
                bool encontrou;
                // 1. Busca a primeira ocorrência na árvore
                ...
                if (encontrou) {
                    ...
                    while (atual != NULL) {
                        ...
                        if (proximaPos != -1) {
                            atual = lerPaginaDoDisco(arvore, proximaPos); // Função que lê página pelo índice
                            i = 0;
                        } else {
                            atual = NULL;
                        }
            ...
            case 4:
                ...
                if (strcmp(inf.nome, sup.nome) <= 0) {
                    ...
                    buscaIntervaloBplus(arvore, cabecalhoBplus, &inf, &sup, ehMenorDadoBusca, imprimeChaveFuncionario, leituraDadoBusca);
                } else {
                    printf("\nErro: O primeiro nome deve ser alfabeticamente menor ou igual ao segundo.\n");
                }
                break;
